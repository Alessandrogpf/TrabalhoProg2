...
void rodar_10x(int* vetor, int tamanho_vetor) {
    ...
    printf("Media e desvio padrao dos tempos de execucao:\n");
...
int main() {
    ...
    imprime_vetor(vetor, tamanho_vetor);
    printf("Tempo de execucao do Quick Sort: %.6f segundos\n", tempo_quick_sort);
    ...
    imprime_vetor(copia_vetor2, tamanho_vetor);
